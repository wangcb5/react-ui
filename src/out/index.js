...
export {default as AutoCompleted} from '@comp/autoCompleted'
export {default as LeTable} from '@comp/table'
export {default as LeUpload} from '@comp/upload'
export {default as Alert} from '@comp/alert'